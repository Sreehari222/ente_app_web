...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="container max-[320px]:px-2">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-[220px] max-[320px]:w-[300px] sm:w-60 max-w-full px-4 xl:mr-12">
              <Link
                href="/"
              ...
              <div>
                ...
                >
                  ...
                  <div className="mt-4 flex flex-col gap-3 md:hidden">
                    <Link
                      href="/signin"
                      className="w-full rounded border border-primary py-2 text-center text-base font-medium text-primary"
                    ...
                    <Link
                      href="/signup"
                      className="w-full rounded bg-primary py-2 text-center text-base font-medium text-white"
                      onClick={() => setNavbarOpen(false)}
                    >
                      Sign Up
                    </Link>
